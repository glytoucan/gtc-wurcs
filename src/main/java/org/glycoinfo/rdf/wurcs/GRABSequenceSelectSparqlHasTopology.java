...
@Component
public class GRABSequenceSelectSparqlHasTopology extends SelectSparqlBean {
	...
	public GRABSequenceSelectSparqlHasTopology(String sparql) {
		super(sparql);
	}

	public GRABSequenceSelectSparqlHasTopology() {
		super();
